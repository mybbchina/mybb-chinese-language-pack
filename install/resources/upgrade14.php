...
function upgrade14_dbchanges2()
{
	...
	$db->update_query("helpdocs", array('document' => $db->escape_string("MyBB使用cookie来储存您的登录信息如果您是注册用户，如果不是则记录您上次的访问信息。<br /><br />Cookie 是一个保存在您电脑里的小型的文本文档；论坛中所设置的 cookie 仅可以在这个网站里使用并不会引起安全风险。<br /><br />论坛中的 Cookie 同时也记录您最近读过的那个主题。<br /><br />要清除所有Cookie，您可以点击<a href=\"misc.php?action=clearcookies&amp;key={1}\">这里</a>。")), "hid='3'", 1);
