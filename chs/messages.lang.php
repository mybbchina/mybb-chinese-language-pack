 ...
 * 
 * $Id: messages.lang.php 4304 2009-01-02 01:11:56Z MyBB中文化团队 $
 */
...
$l['error_alreadyuploaded'] = "这个帖子已经包含了一个相同名字的附件. 请重命名这个文件然后重新上载。";
...
$l['error_nopermission_user_5'] = "您目前已经登录, 用户名是: '{1}'";
