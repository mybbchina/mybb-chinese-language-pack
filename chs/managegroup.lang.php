 ...
 * 
 * $Id: managegroup.lang.php 4304 2009-01-02 01:11:56Z MyBB中文化团队 $
 */
...
$l['reg_date'] = "注册时间";
$l['post_count'] = "发表数";
$l['remove_selected'] = "把选定的用户移出这个组";
$l['add_member'] = "添加成员到 \"{1}\"";
$l['add_member_submit'] = "添加会员到组里";
...
$l['group_default'] = "这是一个系统核心的用户组。";

$l['error_alreadyingroup'] = "这个用户已经是这个组的成员之一了。";
?>