 ...
 *
 * $Id: reputation.lang.php 4304 2009-01-02 01:11:56Z MyBB中文化团队 $
 */
...
$l['add_no_comment'] = "您必须输入一个合适的理由(评论), 才能做出评价。";
...
$l['negative'] = "否定";
$l['neutral'] = "中立";
$l['user_comments'] = "您对 {1} 的评论或意见(不少于10字):";
$l['add_vote'] = "添加评价";
$l['update_vote'] = "更新";
$l['delete_vote'] = "删除";
$l['power_positive'] = "肯定 ({1})";
$l['power_neutral'] = "中立";
$l['power_negative'] = "否定 ({1})";
$l['show_all'] = "显示: 所有评价";
