 ...
 * 
 * $Id: member.lang.php 4270 2008-11-15 08:03:49Z MyBB中文化团队 $
 */

$l['nav_register'] = "注册";
$l['nav_activate'] = "激活";
$l['nav_resendactivation'] = "重发激活说明邮件(Email)";
...
$l['lastvisit'] = "最近访问";
$l['total_posts'] = "帖子总数:";
$l['ppd_percent_total'] = "每天 {1} 篇 | 约占总帖子的 {2}%";
$l['find_posts'] = "查看他的全部主题";
$l['find_threads'] = "查看他的全部帖子";
$l['rating'] = "评分:";
$l['users_contact_details'] = "{1} 的联系方式";
$l['homepage'] = "主页:";
$l['pm'] = "私人短信:";
$l['send_pm'] = "给 {1} 发送私人短信。";
$l['icq_number'] = "ICQ 号码:";
...
$l['agreement'] = "注册协议";
$l['agreement_1'] = "虽然我们试图修改或删除不恰当的帖子或信息, 包括带有性倾向, 辱骂, 可恶, 诽谤性或胁迫性等可被视为侵犯个人隐私的材料, 或以其它方式违反任何一个法律法规的. 但是我们也不可能审查每一个发布在这个论坛里的帖子或信息. 出于这个原因, 您应当承认所有发布在这个论坛里的帖子及消息所表达的仅代表原作者的观点和意见而与这个论坛无关. 因此, 我们不承担责任以及发布的帖子可能引起的法律责任. 我们也不担保或保证每篇帖子的准确性和完整性。";
$l['agreement_2'] = "注册在这个论坛即表示您同意将不会发布任何已知欺诈, 不准确, 辱骂, 可恶, 骚扰, 性倾向, 威胁或侵犯个人隐私, 或者任何可能违反任何适用法律的消息或帖子。";
$l['agreement_3'] = "如果不遵守这些规则可能会导致终止您的帐号, 帐号暂停甚至永久禁止进入这个论坛. 您的 IP 地址都被记录在您发布的每篇帖子里, 如果有必要论坛工作人员可以提取出来. 您应当同意我们在适当的情况下有权利在任何时候删除, 修改或锁定任何帐号及帖子. 您应当知道您在这个论坛所输入的全部信息被存储在服务器的数据库中, 而保存您的登录信息的 \"cookies\" 是存储在您的计算机(电脑)里。";
$l['agreement_4'] = "在未经您完全同意的情况下, 任何您提供在这个论坛里的信息都不会透露给任何第三方. 在黑客入侵从而导致危及您的数据安全时, 论坛工作人员不承担责任。";
$l['agreement_5'] = "在继续注册前, 您应当同意上述和其他管理员指定的所有规则。";
$l['registration'] = "注册";
$l['required_fields'] = "必填的项目";
...
$l['receive_pms'] = "接收来自其它用户的私人短信(PM)。";
$l['pm_notice'] = "当我收到私人短信时提醒我。";
$l['email_notify_newpm'] = "当我收到私人短信时发送 Email 通知我。";
...
$l['coppa_registration'] = "COPPA 注册表单";
...
$l['lang_select'] = "语言设定:";
$l['lang_select_desc'] = "如果您居住在使用不同于论坛设定的默认语言的国家, 您可以从下面选一个已安装, 易读的语言包。";
$l['lang_select_default'] = "使用默认的";

$l['submit_registration'] = "提交注册!";
$l['confirm_password'] = "确认密码:";
$l['referrer'] = "推荐人:";
$l['referrer_desc'] = "如果您是另一个论坛会员介绍您来这个论坛的, 您可以在下面填入他的用户名. 如果不是, 请直接留空。";
$l['resend_activation'] = "重发帐号激活说明邮件(Email)";
$l['request_activation'] = "需要激活认证码";
$l['ppp'] = "每页显示的帖子数:";
...
$l['none_registered'] = "未登记";
$l['not_specified'] = "未指定";
$l['membdayage'] = "({1} 岁)";
$l['mod_options'] = "管理选项";
$l['edit_in_mcp'] = "在中控面板中编辑这个用户";
$l['ban_in_mcp'] = "在中控面板中禁止这个用户";
$l['reputation'] = "声望:";
...
$l['redirect_registered'] = "感谢您在 {1} 注册, {2}.<br />现将转入论坛主页。";
$l['redirect_registered_admin_activate'] = "感谢您在 {1} 注册, {2}.<br />您的帐号必须由管理员进行审核激活, 在这之前您可能无法在这里的论坛发帖。";
$l['redirect_loggedout'] = "您已经成功退出登录了.<br />现将返回到论坛首页。";
$l['redirect_alreadyloggedout'] = "您已经退出登录或还没有登录.<br />现将返回到论坛首页。";
$l['redirect_lostpwsent'] = "非常感谢, 所有和那个 Email 有关的帐号都将收到一封详细介绍如何重置密码的电子邮件(Email).<br /><br />现将转入论坛首页。";
...
$l['error_activated_by_admin'] = "所有的注册均必须等待管理员的审核批准, 因此您不能重新寄出帐号激活信(Email)。";
...
$l['error_nothreadurl'] = "您的内容没有包含主题的网址 URL. 请使用 \"发送给朋友\" 功能来达到目的。";
$l['error_invalidpworusername'] = "您输入了一个无效的用户名和密码组合. <br /><br />如果您忘了密码, 请尝试<a href=\"member.php?action=lostpw\">找回密码</a>。";
...
$l['error_regimagerequired'] = "请输入验证码以继续登陆过程。";
...
$l['js_validator_no_image_text'] = "你需要输入上图中的文字";
$l['js_validator_password_matches'] = "您输入的密码必须相匹配";
$l['js_validator_password_complexity'] = "密码必须包含一个或多个特殊符号";
...
$l['instant_email_subscribe'] = "即时的 Email 通知";
?>