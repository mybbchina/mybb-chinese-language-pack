...
//]]>
	...
	function output_footer($quit=true)
	{
		...
		echo "	<br style=\"clear: both;\" />";
		echo "	</div>\n";
		echo "<div id=\"footer\"><p class=\"generation\">".$lang->sprintf($lang->generated_in, $totaltime, $querycount, $memory_usage)."</p><p class=\"powered\">Powered By MyBB. &copy; ".COPY_YEAR." MyBB Group. All Rights Reserved. MyBB中文语系由 <a href=\"http://www.mybbchina.net\" target=\"_blank\">MyBB中文站</a> 制作维护.</p></div>\n";
		if($mybb->debug_mode)
		{
			echo $db->explain;
		}
