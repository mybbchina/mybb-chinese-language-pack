...
<div id="footer">
<?php echo $lang->powered_by; ?> <a href="http://mybb.com">MyBB</a><?php echo $mybbversion; ?>, &copy; 2002-<?php echo date("Y"); ?> <a href="http://mybb.com">MyBB Group</a>. MyBB中文语系由 <a href="http://www.mybbchina.net" target="_blank">MyBB中文站</a> 制作维护.
</div>
</body>
</html>
<?php
